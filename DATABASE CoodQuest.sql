...
INSERT INTO Quizzes (quiz_name, category_id) VALUES
('Python is widely used in data science, artificial intelligence, and cybersecurity.', 4),
('PHP cannot be used for e-commerce websites.', 4),
('C# supports object-oriented programming and is commonly used in game development.', 4),
('A Database Management System (DBMS) helps store, retrieve, and modify data efficiently.', 4),
('A Personal Area Network (PAN) covers a larger area than a Wide Area Network (WAN).', 4),

('Which of the following is a key advantage of Python?', 4),
('Which language is commonly used for server-side scripting in web development?', 4),
('Which of the following is an advantage of using C#?', 4),
('Which type of database management system stores data in tables with structured relationships?', 4),
('Which network type is best suited for connecting multiple branches of a company across a city?', 4),

('Python is only used for web development and cannot be applied in artificial intelligence.', 4),
('PHP is widely used for building content management systems like WordPress.', 4),
('C# is mainly used for mobile app development and has no role in game development.', 4),

('Which of the following industries benefit from Python?', 4),
('Which of the following is a major use of PHP?', 4),
('Which network topology connects all devices in a single continuous loop?', 4),
('Which type of database is best suited for handling structured data with relationships?', 4);
...
ALTER TABLE questions ADD COLUMN  question_type ENUM('True/False', 'Multiple Choice') NOT NULL;
ALTER TABLE questions ADD COLUMN  category VARCHAR(100);

ALTER TABLE questions MODIFY COLUMN correct_answer char(1);


INSERT INTO quizzes (quiz_name) VALUES ('Quiz 1'), ('Quiz 2');

INSERT INTO questions (quiz_id, category, question_text, question_type, correct_answer) VALUES
(1, 'Python', 'Python is widely used in data science, artificial intelligence, and cybersecurity.', 'True/False', 'T'),
(1, 'PHP', 'PHP cannot be used for e-commerce websites.', 'True/False', 'F'),
(1, 'C#', 'C# supports object-oriented programming and is commonly used in game development.', 'True/False', 'T'),
(1, 'DBMS', 'A Database Management System (DBMS) helps store, retrieve, and modify data efficiently.', 'True/False', 'T'),
(1, 'Networking', 'A Personal Area Network (PAN) covers a larger area than a Wide Area Network (WAN).', 'True/False', 'F');

INSERT INTO questions (quiz_id, category, question_text, question_type, option_a, option_b, option_c, option_d, correct_answer) VALUES
(1, 'Python', 'Which of the following is a key advantage of Python?', 'Multiple Choice', 'Complex syntax', 'Beginner-friendly and powerful', 'Limited library support', 'Only used for web development', 'B'),
(1, 'PHP', 'Which language is commonly used for server-side scripting in web development?', 'Multiple Choice', 'Python', 'PHP', 'C#', 'JavaScript', 'B'),
(1, 'C#', 'Which of the following is an advantage of using C#?', 'Multiple Choice', 'Automatic memory management', 'Not compatible with .NET framework', 'No support for object-oriented programming', 'Only used for desktop applications', 'A'),
(1, 'DBMS', 'Which type of database management system stores data in tables with structured relationships?', 'Multiple Choice', 'NoSQL DBMS', 'Distributed DBMS', 'Relational DBMS', 'Cloud DBMS', 'C'),
(1, 'Networking', 'Which network type is best suited for connecting multiple branches of a company across a city?', 'Multiple Choice', 'LAN', 'PAN', 'MAN', 'WAN', 'C');

INSERT INTO questions (quiz_id, category, question_text, question_type, correct_answer) VALUES
(2, 'Python', 'Python is only used for web development and cannot be applied in artificial intelligence.', 'True/False', 'F'),
(2, 'PHP', 'PHP is widely used for building content management systems like WordPress.', 'True/False', 'T'),
(2, 'C#', 'C# is mainly used for mobile app development and has no role in game development.', 'True/False', 'F');

INSERT INTO questions (quiz_id, category, question_text, question_type, option_a, option_b, option_c, option_d, correct_answer) VALUES
(2, 'Python', 'Which of the following industries benefit from Python?', 'Multiple Choice', 'Web development', 'Data science', 'Cybersecurity', 'All of the above', 'D'),
(2, 'PHP', 'Which of the following is a major use of PHP?', 'Multiple Choice', 'Machine learning', 'Web development', 'Operating system design', 'Game development', 'B'),
(2, 'Networking', 'Which network topology connects all devices in a single continuous loop?', 'Multiple Choice', 'Star', 'Mesh', 'Bus', 'Ring', 'D'),
(2, 'DBMS', 'Which type of database is best suited for handling structured data with relationships?', 'Multiple Choice', 'NoSQL', 'Relational DBMS', 'Key-Value Store', 'Document-based DBMS', 'B');
